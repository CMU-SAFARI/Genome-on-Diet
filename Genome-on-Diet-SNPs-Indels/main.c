...
int main(int argc, char *argv[]) {
	...
	if (argc == o.ind || fp_help == stdout) {
		...
		fprintf(fp_help,
		        ...
		        opt.min_cnt);
		fprintf(fp_help,
		        "    --AF_dis FLOAT    maximum length (AF_dis * read length) of a region span for Adjacency "
		        "Filtering [%g]\n",
		        opt.AF_dis);
		fprintf(fp_help, "    --AF_max_loc INT  maximum number of locations after adjacency filtering [%d]\n",
		        opt.AF_max_loc);
		...
		fprintf(fp_help,
		        "    -r FLOAT[,INT,INT] chaining/alignment bandwidth and long-join bandwidth [%f,%d,%d]\n",
