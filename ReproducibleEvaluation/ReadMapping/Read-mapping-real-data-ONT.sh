...
do
    ...
    sbatch --exclusive -w kratos5 -c 40 -J bwa_hg38 -o "ONT/minimap2-GRCh38-ONT-stats-command-out_k15w$i.txt" --wrap="/usr/bin/time -v --output "ONT/minimap2-GRCh38-ONT-stats-time-memory_k15w$i.txt" ./minimap2 -t 40 --MD -ax map-ont -N 1 -a -k 15 -w $i --secondary=yes -o "ONT/minimap2-GRCh38-ONT-stats_k15w$i.sam" GCA_000001405.15_GRCh38_no_alt_analysis_set.fasta ${FASTQpath}"
